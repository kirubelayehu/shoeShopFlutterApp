...
class CartDataProvider {
  ...
  Future<void> getUserCart(String userid) async {
    print("User Cart loading ......");
    Response response;
    try {
      response = await httpClient.get('$_baseUrl/cart/$userid');
      print(response.statusCode);
    } catch (e) {
      print(e.toString());
    }
    if (response.statusCode == 200) {
      ...
      throw Exception("Cant Get Cart Item ");
    }
  }
  ...
  Future<void> deleteCart(String id) async {
    ...
    print(
        "Deltting Cart........................................................... ");
    try {
      final Response response = await httpClient.delete('$_baseUrl/cart/$id',
          headers: {'Content-Type': 'application/json'});
      print(response.statusCode);
